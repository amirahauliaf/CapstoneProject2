package com.submission2.capstoneproject2.ui.home
...
import com.submission2.capstoneproject2.ui.BaseApplication
import com.submission2.capstoneproject2.databinding.FragmentHomeBinding
...
class HomeFragment : Fragment(), MovieAdapterClickListener {
    ...
    private fun visibleView(theView: View) {
        _binding.rvMovies.visibility = if (_binding.rvMovies == theView) { View.VISIBLE} else { View.GONE }
        _binding.tvViewError.visibility = if (_binding.tvViewError == theView ) { View.VISIBLE } else { View.GONE }
        _binding.noHomeFound.root.visibility = if (_binding.noHomeFound.root == theView) { View.VISIBLE } else { View.GONE }
        _binding.progressBar.visibility = if (_binding.progressBar == theView) { View.VISIBLE } else { View.GONE }
    }
}