package com.submission2.capstoneproject2.ui.detail
...
import com.submission2.capstoneproject2.R
import com.submission2.capstoneproject2.databinding.ActivityDetailMovieBinding
                    ...
                    when(movies) {
                        ...
                        is Resource.Success -> {
                            ...
                            if (!movies.data.isNullOrEmpty()) {
                                ...
                                binding.viewErrorDetailMovie.text = resources.getString(R.string.empty_text)
                                binding.llContentDetailMovie.visibility = View.GONE
                                binding.viewErrorDetailMovie.visibility = View.VISIBLE
                            }
                        }
                        is Resource.Error -> {
                            binding.viewErrorDetailMovie.text = resources.getString(R.string.oops_something_went_wrong)
                            binding.llContentDetailMovie.visibility = View.GONE
                            binding.progressBarDetailMovie.visibility = View.GONE
                            binding.viewErrorDetailMovie.visibility = View.VISIBLE
                        }
