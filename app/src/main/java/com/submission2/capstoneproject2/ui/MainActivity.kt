...
import com.submission2.capstoneproject2.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    private fun instantiateFragment(): Fragment? {
        return try {
            Class.forName("com.capstoneproject2.favorite.FavoriteFragment").newInstance() as Fragment
        } catch (e: Exception) {
            null
        }
    }
